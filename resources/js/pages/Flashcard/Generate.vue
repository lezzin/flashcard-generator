...
const submit = async () => {
    ...
    try {
        ...
        successMessage.value =
            'Success! Your flashcards are being generated in the background.';
        form.reset();
    } catch (_) {
        errorMessage.value =
            'A network error or unexpected issue occurred. Please try again.';
    } finally {
        ...
        <div class="mx-auto max-w-2xl px-4">
            <header class="mb-10 text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Paste your study content and let AI create the perfect
                    flashcards.
                </p>
            </header>
                ...
                >
                    ...
                    <div class="space-y-1.5">
                        ...
                        <p class="text-xs text-gray-500">
                            Provide a clear description for better results.
                        </p>
