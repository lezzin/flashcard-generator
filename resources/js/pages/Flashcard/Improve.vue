...
const fetchDecks = async () => {
    ...
    try {
        ...
        errorMessage.value =
            'Failed to load deck list. Please ensure Anki is running with AnkiConnect.';
    } finally {
    ...
    try {
        ...
        if (!response.ok) {
            if (response.status === 422 && result.errors) {
                ...
                errorMessage.value =
                    result.message ||
                    'An error occurred while attempting to improve cards.';
            }
        ...
        <div class="mx-auto max-w-2xl px-4">
            <header class="mb-10 text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    Enhance your flashcards by identifying and bolding critical
                    keywords.
                </p>
            </header>
            ...
            <div class="space-y-6">
                ...
                >
                    <div class="space-y-1.5">
                        ...
                        >
                            No decks found. Make sure Anki is open with the
                    ...
                    <div
                        class="flex items-center justify-end border-t border-gray-100 pt-6"
                    >
                        <PrimaryButton
                ...
                <div class="rounded-lg border border-blue-100 bg-blue-50 p-6">
                    <h3
                        class="flex items-center gap-2 text-sm font-semibold text-blue-900"
                    >
                        <svg
                    ...
                    <ul
                        class="mt-4 grid grid-cols-1 gap-4 text-xs leading-relaxed text-blue-800 sm:grid-cols-2"
                    >
                        <li>
                            The system will fetch all cards from your selected
                            deck.
                        </li>
                        <li>
                            It will analyze and <strong>bold</strong> critical
                            keywords.
                        </li>
                        <li>
                            Complex sentences will be simplified for better
                            recall.
                        </li>
                        <li>
                            Changes are automatically updated in your local
                            Anki.
                        </li>
                    </ul>
                </div>
